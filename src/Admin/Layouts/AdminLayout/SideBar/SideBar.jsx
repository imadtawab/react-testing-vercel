...
import { BsFillGiftFill,BsFillArchiveFill, BsFillTagFill, BsHash, BsBoxFill } from "react-icons/bs"
...
export default function SideBar({sideBarShow,setSideBarShow}) {
  return (
    <section className={`SideBar ${sideBarShow ? '' : "closed"}`}>
